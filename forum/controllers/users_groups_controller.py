...
def join_group(request):
    if (request.method == 'POST'):
        ...
        notifikasi.isi_notifikasi = "<img class='ui avatar image' src='/static/images/avatar_user/"+sender.avatar_user+"'><a href='/forum/user/view/" + sender.email + "'>" + sender.full_name + "</a> Join to Your Group " + "<img class='ui avatar image' style='border-radius:4px;' src='/static/images/avatar_group/"+grup.avatar_grup+"'><a href='/forum/group/edit/" + id_grup + "'>" + grup.nama_grup + "</a>"
        notifikasi.save()
        return HttpResponse("")
    else:
        return render(request, '404.html')
...
def leave_group(request):
    if (request.method == 'POST'):
        ...
        notifikasi.isi_notifikasi = "<img class='ui avatar image' src='/static/images/avatar_user/"+sender.avatar_user+"'><a href='/forum/user/view/" + sender.email + "'>" + sender.full_name + "</a> Leave from Your Group " + "<img class='ui avatar image' style='border-radius:4px;' src='/static/images/avatar_group/"+grup.avatar_grup+"'><a href='/forum/group/edit/" + id_grup + "'>" + grup.nama_grup + "</a>"
        notifikasi.save()
...
def accept_user(request):
    if (request.method == 'POST'):
        ...
        notifikasi.isi_notifikasi = "<img class='ui avatar image' src='/static/images/avatar_user/"+sender.avatar_user+"'><a href='/forum/user/view/" + sender.email + "'>" + sender.full_name + "</a> Accept Your Request to Join Group " + "<img class='ui avatar image' style='border-radius:4px;' src='/static/images/avatar_group/"+grup.avatar_grup+"'><a href='/forum/group/view/" + id_grup + "'>" + grup.nama_grup + "</a>"
        notifikasi.save()
        return HttpResponse("")
...
def reject_user(request):
    if (request.method == 'POST'):
        ...
        notifikasi.isi_notifikasi = "<img class='ui avatar image' src='/static/images/avatar_user/"+sender.avatar_user+"'><a href='/forum/user/view/" + sender.email + "'>" + sender.full_name + "</a> Reject Your Request to Join Group " + "<img class='ui avatar image' style='border-radius:4px;' src='/static/images/avatar_group/"+grup.avatar_grup+"'><a href='/forum/group/view/" + id_grup + "'>" + grup.nama_grup + "</a>"
        notifikasi.save()
